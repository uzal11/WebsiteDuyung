            ...
            <div class="row">
                <div class="col-12">
                    <nav class="navbar navbar-expand-lg">
                        <!-- Logo -->
                        <a class="navbar-brand" href="{{route('index')}}"><img src="img/core-img/logo.png" alt="Logo"></a>
                        <!-- Navbar Toggler -->
                            ...
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        ...
                                        <a class="dropdown-item" href="{{route('category')}}">Catagory</a>
                                        <a class="dropdown-item" href="{{route('single-blog')}}">Single Blog</a>
                                        <a class="dropdown-item" href="{{route('regular-page')}}">Regular Page</a>
