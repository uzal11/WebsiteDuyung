...
<body>
            ...
            <div class="row">
                <div class="col-12">
                    <nav class="navbar navbar-expand-lg">
                        <!-- Logo -->
                        <a class="navbar-brand" href="{{route('index')}}"><img src="img/core-img/logoduyung.png" alt="Logo"></a>
                        <!-- Navbar Toggler -->
                        ...
                        <div class="collapse navbar-collapse" id="worldNav">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Wahana</a>
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="{{route('index')}}">Home</a>
                                        <a class="dropdown-item" href="{{route('category')}}">Galery</a>
                                        <a class="dropdown-item" href="{{route('single-blog')}}">Potensi Alam</a>
                                        <a class="dropdown-item" href="{{route('regular-page')}}">Event</a>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#">Potensi Alam</a>
                                </li>
                                <li class="nav-item">
    ...
    <div class="hero-area">
        ...
        <div class="hero-slides owl-carousel">
            <!-- Single Slide -->
            <div class="single-hero-slide bg-img background-overlay" style="background-image: url(img/blog-img/AirTerjun.jpg);"></div>
            <!-- Single Slide -->
            <div class="single-hero-slide bg-img background-overlay" style="background-image: url(img/blog-img/SpotFoto.jpg);"></div>
            <div class="single-hero-slide bg-img background-overlay" style="background-image: url(img/blog-img/Payung.jpg);"></div>
            <div class="single-hero-slide bg-img background-overlay" style="background-image: url(img/blog-img/Wahana.jpg);"></div>
        </div>
    </div>
    <!-- ********** Hero Area End ********** -->
